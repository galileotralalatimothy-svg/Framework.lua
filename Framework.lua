...
function Library:Window(p)
    ...
    UICorner_Background.CornerRadius = UDim.new(0, 10)
    UICorner_Background.Parent = Background_1

    local UIStroke_Background = Instance.new("UIStroke")
    UIStroke_Background.Parent = Background_1
    UIStroke_Background.Color = Color3.fromRGB(255, 255, 255)
    UIStroke_Background.Thickness = 1
    UIStroke_Background.Transparency = 0.6
    UIStroke_Background.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	...
	do
		...
		do
            ...
            FrameCloseUI_1.AnchorPoint = Vector2.new(0.5, 0.5)
            ...
            FrameCloseUI_1.Position = UDim2.new(0.5, 0, 0.5, 0)
            FrameCloseUI_1.Size = UDim2.new(0, 40, 0, 40)

            local UICorner_FrameClose = Instance.new("UICorner")
            UICorner_FrameClose.CornerRadius = UDim.new(1, 0)
            UICorner_FrameClose.Parent = FrameCloseUI_1

            local ImageCloseUI = Instance.new("ImageButton")
            ImageCloseUI.Name = "ImageCloseUI"
            ImageCloseUI.Parent = FrameCloseUI_1
            ImageCloseUI.BackgroundTransparency = 1
            ImageCloseUI.Size = UDim2.new(1, 0, 1, 0)
            ImageCloseUI.Image = "rbxassetid://130598277531514" -- PALITAN MO KUNG GUSTO MO
            ImageCloseUI.ScaleType = Enum.ScaleType.Fit
            ImageCloseUI.AutoButtonColor = false

            ImageCloseUI.MouseButton1Click:Connect(function()
